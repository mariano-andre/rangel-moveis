    ...
    <Modal title="Avançar etapa" onClose={onClose}>
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-bg-elevated rounded-lg p-4 flex flex-col gap-3 text-sm">
          <div>
            <p className="text-[11px] uppercase tracking-wide text-text-muted mb-0.5">Etapa atual</p>
          ...
          {nextStep && (
            <>
              ...
              <div>
                <p className="text-[11px] uppercase tracking-wide text-text-muted mb-0.5">Próxima etapa</p>
